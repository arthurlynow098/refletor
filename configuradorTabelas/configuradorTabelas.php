    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          <label class="form-label">Configuração de Barra</label><input type="text" class="config-input"
            id="config-barra" value="FLASH STD" />
        </div>
        <div class="form-group">
          <label class="form-label">Modelo da Barra</label><input type="text" class="config-input" id="modelo-barra"
            value="Linha S-Slim" />
        </div>
        <div class="form-group">
          <label class="form-label">Sub-família</label><input type="text" class="config-input" id="sub-familia"
            value="S-SLIM Bicolor" />
        </div>
        <div class="form-group">
          <label class="form-label">Tamanho da Barra</label><input type="text" class="config-input" id="tamanho-barra"
            value="1200mm" />
        </div>
      </div>
